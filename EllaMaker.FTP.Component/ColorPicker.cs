...
{
    public class HtmlColorDisplayConveter : IValueConverter
    {
        ...
        public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            if (Regex.IsMatch(value.ToString(), "[0-f0-F]{8}"))
            {
    ...
    public class ColorPicker : Control
    {
        ...
        public ColorPicker()
        {
            ...
            this.OpenPopCmd = new ActionCommand<MouseButtonEventArgs>((sender, e) =>
            {
                IsOpenPop = false;
                IsOpenPop = true;
            });
            // Register Event Handler for slider
            EventManager.RegisterClassHandler(typeof(ColorPicker), Slider.ValueChangedEvent, new RoutedPropertyChangedEventHandler<double>(OnSliderValueChanged));
        ...
        {
            get { return (bool)GetValue(IsOpenPopProperty); }
            set { SetValue(IsOpenPopProperty, value); }
        }
        public static readonly DependencyProperty IsOpenPopProperty =
            DependencyProperty.Register("IsOpenPop", typeof(bool), typeof(ColorPicker),
                new UIPropertyMetadata(false));
        public ActionCommand<MouseButtonEventArgs> OpenPopCmd { get; private set; }
        ...
        private void OnHsvControlSelectedColorChanged(object sender, RoutedPropertyChangedEventArgs<Color> e)
        {
            ColorPicker colorPicker = sender as ColorPicker;
