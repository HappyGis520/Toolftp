...
{
    public class INIOperationHelper
    {
        #region INI文件操作  
        ...
        public static bool INIWriteValue(string iniFile, string section, string key, string value)
        {
            ...
            return INIOperationHelper.WritePrivateProfileString(section, key, value, iniFile);
        ...
        public static bool INIDeleteSection(string iniFile, string section)
        {
            ...
            return INIOperationHelper.WritePrivateProfileString(section, null, null, iniFile);
        }
